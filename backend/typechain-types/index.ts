...
export type { MockERC20Token } from "./contracts/MockERC20Token";
export { MockERC20Token__factory } from "./factories/contracts/MockERC20Token__factory";
export type { ProjectSubmission } from "./contracts/ProjectSubmission";
export { ProjectSubmission__factory } from "./factories/contracts/ProjectSubmission__factory";
